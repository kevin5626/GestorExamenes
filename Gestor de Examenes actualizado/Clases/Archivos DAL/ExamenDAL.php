<?php
    ...
    class ExamenDAL {
        ...
        public function insertExamen($examen) {
            ...
            $consulta = (sprintf("INSERT INTO examenes (tema, fechaExamen, enlaceAcceso) VALUES('%s', '%s', '%s');",
            $examen -> getNombre(), $examen -> getApellido()));
        ...
        public function getExamenes(): array {
            ...
            while($registro = mysqli_fetch_array($resultado)) {
                $examen = new Tutor ($registro["idExamen"], $registro["tema"], $registro["fechaExamen"], $registro["enlaceAccceso"]);
